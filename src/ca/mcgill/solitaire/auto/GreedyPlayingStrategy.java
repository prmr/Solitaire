 ...
 * 5. Moving from one pile in the tableau to another, if this either reveals a fresh card or frees up a
 *    pile for a king. 
...
public class GreedyPlayingStrategy implements PlayingStrategy {
	...
	/*
	 * If it's possible to move the top of the discard pile to the foundation,
	 * do it.
	 */
	...
	/*
	 * Only if it reveals a card or empties a pile. We also don't move kings
	 * between empty piles
	 */
