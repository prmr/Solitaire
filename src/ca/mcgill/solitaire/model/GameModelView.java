...
public interface GameModelView {
	 ...
	 * @return True if pCard is in the tableau and is the lowest card visible in
	 *     its pile, including the case where it's the only card in the pile.
	 */
	...
	/**
	 * @return An instance of the Move interface that represents no move at all.
	 */
	Move getNullMove();
	...
	/**
	 * Get a Move that represents moving a card (and possibly all cards below it
	 * if applicable) to pDestination.
	 * 
