...
class Foundations {
	...
	/**
	 * Creates an initialized FoundationPiles object that consists of four empty
	 * piles.
	 */
	Foundations() {
		initialize();
	 ...
	 * @return True if pCard can be moved to the top of pLocation. This is only
	 *     possible if its rank is immediately superior to that of the card
	 *     currently on top of the pile or, in the case of an Ace, if the location
	 *     is empty.
