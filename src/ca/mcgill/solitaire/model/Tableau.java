 ...
 * stacked in alternating suit colors, and where cards can be moved from pile to
 * pile.
 */
class Tableau {
	...
	/**
	 * Returns a copy of the entire pile at the specified position in the
	 * tableau.
	 * 
	...
	/**
	 * Returns a sequence of cards starting at pCard and including all cards on
	 * top of it.
	 * 
	...
	/**
	 * @param pCard The card to check.
	 * @return True if the card is visible and there is no visible card below it
	 *     in its pile. This includes the case where the card is at the bottom of
	 *     the pile.
	 * @pre pCard != null && contains(pCard).
	 */
	...
	/**
	 * Places a card on top of the pile at pIndex. The card will be visible by
	 * default.
	 * 
